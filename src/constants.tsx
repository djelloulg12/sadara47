...
/* ----------------------- وحدة البرنامج الأسبوعي ----------------------- */
/** المسابح المعتمدة لبرمجة الحصص الأسبوعية */
export const SCHEDULE_POOLS = [
  'مسبح شبه أولمبي نوميرات',
  'مسبح شبه أولمبي واد نشو',
  'المسبح الجواري بوهراوة',
] as const;

/** الأحواض المتوفرة داخل كل مسبح */
export const POOL_BASINS = ['الحوض 1', 'الحوض 2', 'الحوض 3'] as const;

/** ترتيب أيام الأسبوع التدريبي */
export const WEEK_DAYS = ['السبت', 'الأحد', 'الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس'] as const;

/** الحد الأقصى للأفواج داخل نفس المسبح في الخانة الزمنية الواحدة */
export const POOL_MAX_GROUPS = 4;
